      ...
      <Container>
        <div className="flex flex-col gap-y-10 sm:flex-row-reverse sm:gap-x-10">
          <div className="flex flex-col gap-y-5 sm:w-1/2 sm:justify-center">
            <h2 className="text-3xl font-semibold leading-relaxed text-white md:text-4xl md:leading-relaxed xl:text-5xl xl:leading-relaxed">
              Easily control your billing & invoicing.
            </h2>
            <p className="max-w-[403px] text-base font-normal leading-normal text-white sm:text-lg">
          ...
          <div className="relative flex w-full items-center justify-center sm:w-1/2">
            ...
            <div className="blur-4xl absolute -left-[90%] bottom-1/3 h-[470px] w-[405px] rounded-full bg-gradient-to-r from-white to-light-purple opacity-60"></div>
          </div>
        </div>
      </Container>
      <Divider py="py-5 sm:py-10" />
